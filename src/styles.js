const styles = {
  ...
  heroHeadText:
    "font-black text-white lg:text-[60px] sm:text-[45px] xs:text-[30px] text-[40px] lg:leading-[98px] mt-2",
  heroSubText:
    "text-[#dfd9ff] font-medium lg:text-[23px] sm:text-[20px] xs:text-[16px] text-[14px] lg:leading-[40px]",
